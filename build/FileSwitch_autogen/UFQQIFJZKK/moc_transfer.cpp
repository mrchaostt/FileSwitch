...
#include "../../../src/network/transfer.h"
...
template <> constexpr inline auto FileTransfer::qt_create_metaobjectdata<qt_meta_tag_ZN12FileTransferE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'transferRequestReceived'
        QtMocHelpers::SignalData<void(const TransferRequest &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
...
void FileTransfer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->transferRequestReceived((*reinterpret_cast<std::add_pointer_t<TransferRequest>>(_a[1]))); break;
        case 1: _t->transferProgress((*reinterpret_cast<std::add_pointer_t<qint64>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<qint64>>(_a[2]))); break;
        case 2: _t->transferCompleted(); break;
        case 3: _t->transferError((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 4: _t->acceptConnection(); break;
        case 5: _t->readIncomingData(); break;
        case 6: _t->bytesWritten((*reinterpret_cast<std::add_pointer_t<qint64>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (FileTransfer::*)(const TransferRequest & )>(_a, &FileTransfer::transferRequestReceived, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (FileTransfer::*)(qint64 , qint64 )>(_a, &FileTransfer::transferProgress, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (FileTransfer::*)()>(_a, &FileTransfer::transferCompleted, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (FileTransfer::*)(const QString & )>(_a, &FileTransfer::transferError, 3))
            return;
    }
}
...
// SIGNAL 0
void FileTransfer::transferRequestReceived(const TransferRequest & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void FileTransfer::transferProgress(qint64 _t1, qint64 _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1, _t2);
}

// SIGNAL 2
void FileTransfer::transferCompleted()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void FileTransfer::transferError(const QString & _t1)
{
